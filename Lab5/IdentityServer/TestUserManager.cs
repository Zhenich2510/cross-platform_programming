...
namespace IdentityServer
{
    ...
    {
        public readonly List<TestUser> _users;

        /// <summary>
        /// Initializes a new instance of the <see cref="TestUserStore"/> class.
        /// </summary>
        /// <param name="users">The users.</param>
        public TestUserManager(List<TestUser> users)
        {
            _users = users;
        }
    ...
    public static class IdentityServerBuilderExtensions
    {
        ...
        /// <param name="users">The users.</param>
        /// <returns></returns>
        public static IIdentityServerBuilder AddTestUserManager(this IIdentityServerBuilder builder, List<TestUser> users)
        {
            builder.Services.AddSingleton(new TestUserManager(users));
